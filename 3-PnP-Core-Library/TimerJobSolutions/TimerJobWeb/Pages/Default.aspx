<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="TimerJobWeb.Default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="left: 40px; position: absolute;">
            ...
            Actual business logic is located in external component which can be scheduled to be executed from Microsoft Azure or just as well from<br />
        ...
        <br />
            <ul style="list-style-type: square;">
                ...
                <li><b>Step 4:</b> Execute the "remote timer job" console to see that you can access the site using the provided client ID and secret </li>
                <li><i>Note. Each time you deploy from VS, you will have different client ID, so ensure that you have the values correctly done to console app, which is in separate solution to avoid start up project issues</i></li>
            </ul>
            <br />
            <br />
            Alternative for the app client and secret registration is to use the “_layouts/AppRegNew.aspx" page with specific details.
            <br />
            Check following blog posts for additional details related on this capability 
                <br />
            <ul style="list-style-type: square;">
